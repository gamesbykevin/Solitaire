package com.gamesbykevin.solitaire.menu;
...
public final class CustomMenu extends Menu
{
    ...
    public CustomMenu(final Rectangle screen) throws Exception
    {
        //set the container the menu will reside within
        super(screen, Resources.XML_CONFIG_MENU, Resources.class);
     ...
     * @param Main Our gui container class
     * 
     * @throws Exception 
     */
    public void update(final Engine engine, final Main main) throws Exception
    {
